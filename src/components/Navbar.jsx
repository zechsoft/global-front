...
export default function Navbar({ onMenuToggle, user = { name: 'Admin User', email: 'admin@example.com' } }) {
  ...
  return (
    <header className="bg-transparent h-16 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <button 
          className="hidden sm:block p-2 text-white hover:bg-white/20 backdrop-blur-sm rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-white/50"
          aria-label="Settings"
        >
